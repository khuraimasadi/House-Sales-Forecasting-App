# House-Sales-Forecasting-App
This is machine learning app that predict the price of house based on some features such as area, no. of bedrooms etc. The model is based on Random Forest Regressor (Algorithm)r.
# Hi, I'm Abdullah! 👋
